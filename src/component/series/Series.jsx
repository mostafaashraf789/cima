    ...
    <>
      {dataApiMovies ? (
        ...
        <div className=" text-center mt-5 ">
          <i class="fa-solid fa-spinner fa-spin fa-9x text-white"></i>
        </div>
      )}
    </>
  );
